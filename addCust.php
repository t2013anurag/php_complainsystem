      ...
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <tr class="entryTable">
              ...
              <td class="content"><input name="Email" type="text" class="box" id="Email" value="" size="30" maxlength="100" /></td>
            </tr>
            <tr class="entryTable">
              <td class="label">&nbsp;Contact No. </td>
              <td class="content"><input name="Mobile" type="text" class="box" id="Mobile" value="" size="30" maxlength="20" /></td>
            </tr>
            <tr>
              <td width="200">&nbsp;</td>
              <td width="372">&nbsp;</td>
