...
extract($data);
?>
<h3>Edit Department Details - Admin View</h3>
      ...
      <td class="contentArea"><div class="errorMessage" align="center"><?php //echo $errorMessage; ?></div>
          <table width="100%" border="0" cellpadding="2" cellspacing="1" class="text">
            ...
            <tr class="entryTable">
              ...
              <td class="content">
			  <input name="Email" type="text" class="box" id="Email" value="<?php echo $email; ?>" size="30" maxlength="100" /></td>
            </tr>
            <tr class="entryTable">
